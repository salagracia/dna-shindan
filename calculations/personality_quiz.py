...
NARRATIVE_QUESTIONS = [
    {
        "id": "N1",
        "question": "夢中体験：時間を忘れて没頭した経験を、できるだけ具体的に教えてください。",
        "hint": "・何をしていたか／そのときの感覚／終わった後にどんな満足が残ったか",
        "max_length": 2000,
    },
    {
        "id": "N2",
        "question": "譲れない信念：「これだけは曲げない」と思っている価値観を教えてください。",
        "hint": "・信念の言語化／なぜ絶対か（原体験）／守ったことで失ったもの・得たもの",
        "max_length": 2000,
    },
]
